...
import {  create, findAll, topNews, findById, update, deleteById, searchByTitle, findByUserId, findNewsByUsernameController,  likeNews, addComment, deleteComment } from "../controllers/newsController.js" // Controllers
...
router.get("/search-by-username/:username", authMiddleware, findNewsByUsernameController) // Search News posted by the user with the username param on the path
