...
import { create, checkUsername, checkEmail, findById, findByUsername, update } from "../controllers/userController.js" // Controllers
...
router.get("/find-by-username/:username", authMiddleware, findByUsername) // Return the user whith the corresponding username
